...
ALTER TABLE USUARIOS ADD CONSTRAINT NN_NOMBRE_USUARIO CHECK (nombre IS NOT NULL);
ALTER TABLE USUARIOS ADD CONSTRAINT NN_PRIMER_APELLIDO_USUARIO CHECK(primer_apellido IS NOT NULL);
...
ALTER TABLE USUARIOS ADD CONSTRAINT UQ_TELEFONO_USUARIO UNIQUE(telefono);
